...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/end.png", __ASSET__graphics_end_png);
		type.set ("graphics/end.png", AssetType.IMAGE);
		className.set ("graphics/enemy1.png", __ASSET__graphics_enemy1_png);
		type.set ("graphics/enemy1.png", AssetType.IMAGE);
		className.set ("graphics/start.png", __ASSET__graphics_start_png);
		type.set ("graphics/start.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "graphics/enemy1.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "graphics/start.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__graphics_end_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_enemy1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__graphics_start_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep #if display private #end class __ASSET__font_04b_03___ttf extends openfl.text.Font { public function new () { super (); fontName = "04b03"; } } 
...
@:keep #if display private #end class __ASSET__font_5 extends openfl.text.Font { public function new () { super (); fontName = "04b03"; } } 
...
#if openfl
@:keep class __ASSET__font_04b_03___ttf extends openfl.text.Font { public function new () { super (); __fontPath = "font/04B_03__.ttf"; fontName = "04b03"; }}
@:keep class __ASSET__font_5 extends openfl.text.Font { public function new () { super (); __fontPath = "font/04B_03__.ttf"; fontName = "04b03"; }}
...
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_debug.png") class __ASSET__graphics_debug_console_debug_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_hidden.png") class __ASSET__graphics_debug_console_hidden_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_logo.png") class __ASSET__graphics_debug_console_logo_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_output.png") class __ASSET__graphics_debug_console_output_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_pause.png") class __ASSET__graphics_debug_console_pause_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_play.png") class __ASSET__graphics_debug_console_play_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_step.png") class __ASSET__graphics_debug_console_step_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_visible.png") class __ASSET__graphics_debug_console_visible_png extends lime.graphics.Image {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/graphics/preloader/haxepunk.png") class __ASSET__graphics_preloader_haxepunk_png extends lime.graphics.Image {}
@:font("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/font/04B_03__.ttf") class __ASSET__font_04b_03___ttf extends lime.graphics.Font {}
@:bitmap("/Applications/Stencyl-full/plaf/haxe/lib/HaxePunk/2,5,3/assets/font/04B_03__.ttf.png") class __ASSET__font_04b_03___ttf_png extends lime.graphics.Image {}
@:bitmap("assets/graphics/background.png") class __ASSET__graphics_background_png extends lime.graphics.Image {}
@:bitmap("assets/graphics/end.png") class __ASSET__graphics_end_png extends lime.graphics.Image {}
@:bitmap("assets/graphics/enemy1.png") class __ASSET__graphics_enemy1_png extends lime.graphics.Image {}
@:bitmap("assets/graphics/start.png") class __ASSET__graphics_start_png extends lime.graphics.Image {}
@:bitmap("assets/graphics/target.png") class __ASSET__graphics_target_png extends lime.graphics.Image {}
@:font("assets/font/04B_03__.ttf") class __ASSET__font_5 extends lime.graphics.Font {}
